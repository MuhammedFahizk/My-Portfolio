    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-9 gap-8 px-6 sm:px-10">
        ...
        <div className="md:col-span-6 flex flex-col justify-between space-y-8">
          {/* Heading */}
          <div>
            <p className="text-base text-center md:text-left  sm:text-lg text-white/70 mb-4">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-wrap gap-4 justify-center">
                <a
                  ...
                  target="_blank"
                  className=" hero flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 dark:bg-white/10 text-gray-100/60 backdrop-blur-xl border border-black/30 dark:border-white/30 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 active:scale-100"
                >
                ...
                <a
                  ...
                  link="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 rounded-full bg-white/10 text-gray-100/60 backdrop-blur-xl border border-black/30 dark:border-white/30 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 active:scale-100"
                >
              ...
              <div className="flex flex-wrap gap-3 justify-center text-sm">
                {contactLinks.map((link) => (
                  <a
                    ...
                    className="text-primary dark:hover:text-lightS hover:text-lightS underline-offset-4"
                  >
                    {link.label}
                  </a>
                ))}
