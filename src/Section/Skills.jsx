...
tl.fromTo(
      ...
      tl.fromTo(
        ...
        },
        {
          ...
          onComplete: () => {
            ...
            card.classList.add(
              "shadow-[15px_15px_30px_#bebebe,-15px_-15px_30px_#ffffff] dark:shadow-[10px_10px_25px_#0d0d0d,-10px_-10px_25px_#1f1f1f]"
            );
          },
        },
        "<+=0.1"
  ...
  return (
    <section
      ref={containerRef}
      className="relative z-40 h-fit bg-[#f5f5f5] dark:bg-dark  rounded-3xl text-dark py-26 px-6"
    >
      ...
      >
        {skills.map((skill, index) => (
          <div
            ...
            className={`skill-card w-[260px] h-[276px]     rounded-[30px] z-50 shadow-none   p-5 flex-shrink-0 flex flex-col justify-center items-center text-center hover:scale-105`}
          >
